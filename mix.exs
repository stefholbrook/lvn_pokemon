defmodule LvnPokemon.MixProject do
  use Mix.Project
  ...
  defp deps do
    [
      ...
      {:live_view_native_swiftui,
       github: "liveview-native/liveview-client-swiftui", tag: "v0.3.0-alpha.5"},
      ...
      {:live_view_native_stylesheet,
       github: "liveview-native/live_view_native_stylesheet", tag: "0.3.0-alpha.4", override: true},
      {:phoenix, "~> 1.7.11"},
      {:phoenix_ecto, "~> 4.4"},
      {:phoenix_html, "~> 4.0"},
  ...
  defp aliases do
    [
      ...
      "assets.build": ["tailwind lvn_pokemon", "esbuild lvn_pokemon"],
      "assets.deploy": [
        "tailwind lvn_pokemon --minify",
        "esbuild lvn_pokemon --minify",
        "phx.digest"
      ]
    ]
  end
